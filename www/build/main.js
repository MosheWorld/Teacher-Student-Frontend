...
var HomePage = (function () {
     ...
     */
    HomePage.prototype.joinAsTeacherButton = function () {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__providers_api_api__ = __webpack_require__(37);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_api_api__ = __webpack_require__(37);
...
var SingleteacherPage = (function () {
    ...
    */
    SingleteacherPage.prototype.deleteUserDialog = function () {
        var _this = this;
        var alert = this.alertCtrl.create({
    ...
    */
    SingleteacherPage.prototype.deleteUser = function () {
        var _this = this;
        this.apiProvider.httpDelete("auth/deletebyuserid/" + this.teacher.userID + "")
            .subscribe(function (success) {
            var alert = _this.createAlert("Deleted successfully.", "User has been deleted successfully.");
            alert.present();
        }, function (failure) {
            var alert = _this.createAlert("Error", "Something went wrong when removing user from database.");
            alert.present();
        });
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__providers_api_api__ = __webpack_require__(37);
    ...
    NewTeacherLoginPage.prototype.resultFromUserExistEndpoint = function (signedInUser, success, loading) {
        ...
        if (success.exist === true) {
            ...
            this.apiProvider.httpPost('auth/createnewuser', this.user)
                .subscribe(function (success) {
                loading.dismiss();
                _this.goToTeaherFormPage();
            }, function (failure) {
                loading.dismiss();
                _this.failureResponse();
            });
        }
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__providers_api_api__ = __webpack_require__(37);
...
AdminContactUsComponent = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        selector: 'admin-contact-us',template:/*ion-inline-start:"C:\Users\mmosh\Desktop\Moshe Files\Teacher student Project\Frontend\src\components\admin-contact-us\admin-contact-us.html"*/'<mat-accordion class="example-headers-align">\n\n\n\n  <mat-expansion-panel *ngFor="let item of this.contactUsList; let i = index;" [expanded]="step === i" (opened)="setStep(i)"\n\n    hideToggle="true">\n\n    <mat-expansion-panel-header>\n\n      <mat-panel-title>\n\n        {{ item.fullName }}\n\n      </mat-panel-title>\n\n      <mat-panel-description>\n\n        <b> {{ item.contactReason }}</b>\n\n      </mat-panel-description>\n\n    </mat-expansion-panel-header>\n\n\n\n    <ion-row>\n\n\n\n      <ion-col col-12>\n\n        <b>Email:</b> {{ item.email }}\n\n      </ion-col>\n\n\n\n      <ion-col col-12>\n\n        <b>Message:</b> {{ item.message }}\n\n      </ion-col>\n\n    </ion-row>\n\n\n\n    <mat-action-row>\n\n      <button mat-button color="warn" (click)="prevStep()">Previous</button>\n\n      <button mat-button color="primary" (click)="nextStep()">Next</button>\n\n    </mat-action-row>\n\n  </mat-expansion-panel>\n\n\n\n</mat-accordion>'/*ion-inline-end:"C:\Users\mmosh\Desktop\Moshe Files\Teacher student Project\Frontend\src\components\admin-contact-us\admin-contact-us.html"*/
    }),
